...
initialization_vector = b'88E34F8F081779F1'
...
key = b'E9F394370AD40589'
text = 'TUPG1100001001562.030547501027887948d5bb3912933b09476d69f434e260f96aca3a60829877c6dd78b0'.upper()
txt = text
print(txt)

print(encrypt_param(key, txt))